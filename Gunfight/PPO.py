...
#ZFilter for the clip operation
class ZFilter:
...
#Actor-Critic Core Net Structure
...
def ppo(args):
    ...
    for i_episode in range(args.num_episode):
        ...
        while num_steps < args.batch_size:
            stateR,state,_,_,_,_ = Env.reset()
            if args.state_norm:
            ...
            for t in range(args.max_step_per_round):
                ...
                actionB = np.argmax(action,axis=0)
        ...
        for i_epoch in range(int(args.num_epoch * batch_size / args.minibatch_size)):
            ...
            #print(minibatch_states,minibatch_actions)
            ...
            #value clip in the paper,not work well
        ...
        if i_episode % args.log_num_episode == 0:
            print('Episode: {} Reward: {:.4f} total_loss = {:.4f} ' \
                .format(i_episode, reward_record[-1]['meanepreward'], total_loss.data))
            print('-----------------')
